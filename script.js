  ...
  O = vec4(col, 1);
    ...
    const translations = {
        en: {
            ...
            "hero-bio": "I build reliable web and mobile experiences, connect AI into real workflows, and strive to optimally design the systems that keep products fast, maintainable, and useful.",
        ...
        tr: {
            ...
            "hero-bio": "Güvenilir web ve mobil deneyimler geliştiriyorum, AI'ı gerçek iş akışlarına bağlıyorum ve ürünleri hızlı, sürdürülebilir ve kullanışlı tutan sistem tarafını en iyi şekilde tasarlamaya çalışıyorum.",
        ...
        fr: {
            ...
            "hero-bio": "Je construis des expériences web et mobiles fiables, j'intègre l'IA dans des flux de travail réels et je m'efforce de concevoir de manière optimale les systèmes qui rendent les produits rapides, maintenables et utiles.",
